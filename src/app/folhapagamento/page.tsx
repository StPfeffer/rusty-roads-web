    ...
    <div className="w-full flex-col gap-2 mt-8 space-y-4">
      <div className="flex justify-end space-x-4">
        <div id="colaborador" className="w-1/4 flex justify-between bg-padrao2 p-4 rounded-lg content-center ">
          ...
          <select className="bg-padrao3 p-1 ml-2 rounded-md">
              ...
              <option value="uva">Uva dsdads</option>
          </select>
        </div>
      ...
      <div className="flex space-x-4 mt-10">
        ...
        <div className="flex-1 bg-padrao3 p-4 rounded-lg">
          ...
          <p className="text-4xl font-bold text-green-600">R$ 5.000,00</p>
        </div>
      ...
      <div id="lancamentos" className="flex space-x-4">
        ...
        <div id="beneficios" className="flex-1 bg-padrao2 p-4 rounded-lg">
          ...
          <div className="flex justify-between px-4 items-center mb-4">
            ...
            <p className="text-xl text-green-700">R$ 400,00</p>
          </div>
          <div className="flex justify-between px-4 items-center mb-4">
            <div className="flex-col justify-center text-gray-200">
              <p className="text-xl">Vale Alimentação</p>
          ...
          <div className="flex justify-between px-4 items-center mt-10 mb-4">
            ...
            <p className="text-2xl font-medium text-green-600">R$ 400,00</p>
          </div>
        </div>
        ...
        <div id="descontos" className="flex-1 bg-padrao2 p-4 rounded-lg">
          ...
          <div className="flex justify-between px-4 items-center mb-4">
            <div className="flex-col justify-center text-gray-200">
              <p className="text-xl">Vale Alimentação</p>
              <p className="text-sm font-thin">Descrição deste desconto, onde tal</p>
            </div>
            <p className="text-xl text-red-700">R$ 400,00</p>
          </div>
          <div className="flex justify-between px-4 items-center mb-4">
            <div className="flex-col justify-center text-gray-200">
              <p className="text-xl">Vale Alimentação</p>
          ...
          <div className="flex justify-between px-4 items-center mt-10 mb-4">
            <p className="text-2xl font-medium">Total</p>
            <p className="text-2xl font-medium text-red-600">R$ 400,00</p>
          </div>
        </div>
      </div>
